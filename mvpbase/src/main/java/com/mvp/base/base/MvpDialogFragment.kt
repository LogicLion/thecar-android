 ...
 * @date 18-11-17.
 */
abstract class MvpDialogFragment : DaggerAppCompatDialogFragment() {
    ...
    fun showToast(tip: String) {
        activity?.showToast(tip, ToastTime.SHORT)
    }

    fun showToast(@StringRes resId: Int) {
        activity?.showToast(getString(resId), ToastTime.SHORT)
    }
